...
- 屏幕边缘“专注护栏”：连续任务每 5 分钟给予一次即时反馈，10 分钟内出现 3/5 次稳定且未经挂起的任务切换时分级提示；
...
8. 分别验证“返回任务”“本任务所需”“切换任务”和“结束专注”。
9. 锁屏后恢复，确认睡眠区间未被计入应用时间。
10. 导出 JSON 和 CSV，确认没有窗口标题、URL 或输入内容字段。
11. 在 Agent 等待时挂起当前任务，留下一句恢复线索并切换；验证提醒只发送一次，点击「返回任务」后时间轴和回顾立即更新。
